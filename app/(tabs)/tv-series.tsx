      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.showsSection}>
          <Text style={styles.sectionTitle}>
            {searchQuery ? `Search Results (${tvShows.length})` : 
             selectedGenre ? 
               `${genres.find(g => g.id === selectedGenre)?.name} TV Series (${tvShows.length})` :
               `${selectedCategory} TV Series (${tvShows.length})`}
          </Text>
              ...
              ListFooterComponent={
                hasMore && !loading ? (
                  <View style={styles.loadMoreContainer}>
                    <TouchableOpacity style={styles.viewMoreButton} onPress={loadMore}>
